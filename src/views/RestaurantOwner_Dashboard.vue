      ...
      <div class="main-content flex-grow-1 p-4">
        ...
        <div class="banner mb-4 p-4 d-flex justify-content-between align-items-center">
          <div class="banner-text">
            <h1 class="banner-title">Delicious Menu</h1>
            <p class="banner-subtitle">Feel the joy! Order your favorite meals today.</p>
            <p class="banner-contact"><i class="fas fa-phone-alt"></i> Contact us: 267-549-3063</p>
            <button class="btn btn-order-now">Order Now</button>
          </div>
          <div class="banner-image">
            <img src="https://via.placeholder.com/300x200" alt="Menu Item" class="img-fluid rounded" />
          </div>
        </div>
  ...
  export default {
    ...
    setup() {
      ...
      const currentOrders = ref([
        { id: 1, user: "John Doe", location: "New York", totalPrice: 45.99 },
        { id: 2, user: "Jane Smith", location: "California", totalPrice: 30.49 },
        { id: 3, user: "Michael Johnson", location: "Texas", totalPrice: 52.00 },
      ]);
  
      const acceptedOrders = ref([
        { id: 1, user: "John Doe", location: "New York", totalPrice: 45.99, image: 'https://via.placeholder.com/100' },
        { id: 2, user: "Jane Smith", location: "California", totalPrice: 30.49, image: 'https://via.placeholder.com/100' },
      ]);
  
      const rejectedOrders = ref([
        { id: 3, user: "Michael Johnson", location: "Texas", totalPrice: 52.00, image: 'https://via.placeholder.com/100' },
      ]);
