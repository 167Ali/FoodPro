    ...
    <div id="app">
      ...
      <div class="orders-container">
        <div class="orders-section">
          <h2>Active orders</h2>
          <div v-if="activeOrders.length === 0">You have no active orders.</div>
          <div v-else>
        ...
        <div class="orders-section">
          <h2>Past orders</h2>
          <div v-if="pastOrders.length === 0">You have no past orders.</div>
          <div v-else>
            <div v-for="order in pastOrders" :key="order.id" class="order-card">
              ...
              <button class="reorder-button" @click="goToPrevOrderDetails(order.id)">Select items to reorder</button>
            </div>
          </div>
        </div>
      </div>
