<template>
    <div class="filter-search-container">
        <div class="d-flex mb-3">
            <input type="text" class="form-control me-2 w-100" v-model="searchQuery" placeholder="Search..." />
            <button @click="toggleFilter" class="btn "><i class="fa-solid fa-filter fa-lg"
                    style="color: #303640;"></i></button>
        </div>
...
const clearFilter = () => {
    ...
    priceRange.value = [0, 1000000];  // Reset to default values
    startDate.value = '';
    endDate.value = '';
